...
namespace Borfotina_Tudor_Lab2.Controllers
{
    public class AuthorsController : Controller
    {
        private readonly Borfotina_Tudor_Lab2Context _context;

        public AuthorsController(Borfotina_Tudor_Lab2Context context)
        {
            _context = context;
        }
