            ...
            public static void Initialize(IServiceProvider serviceProvider)
            {
               ...
               LibraryContext(serviceProvider.GetRequiredService
                <DbContextOptions<LibraryContext>>()))
                {
                    ...
                    {
                        Title = "Baltagul",
                        Author = new Author { FirstName = "Mihail", LastName = "Sadoveanu" },Price=Decimal.Parse("22")},


                    new Book
                    {
                        Title = "Enigma Otiliei",
                        Author = new Author { FirstName = "George", LastName = "Calinescu" },Price=Decimal.Parse("18")},


                    new Book
                    {
                        Title = "Maytrei",
                        Author = new Author { FirstName = "Mircea", LastName = "Eliade" },Price=Decimal.Parse("27")}
